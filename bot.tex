...
\begin{figure}
 \includegraphics[width=25mm]{glmnet-cvm-permutations} 
\caption{ \label{fig:prediction} Prediction with elastic net and compariosn to LDDMM manifold model based linear models.} 
\end{figure}
...
\end{tabular}
\caption{ \label{fig:prediction} Prediction with elastic net and comparison to linear models based on the LDDMM manifold approach.} 
\end{figure}
