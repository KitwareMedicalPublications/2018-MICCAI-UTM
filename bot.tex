...
\multicolumn{3}{c}{Pearson's r }\\
        -0.9 & \includegraphics[width=0.5\linewidth]{colorbar} & 0.9
\end{tabular}\\
...
\includegraphics[width=0.15\linewidth]{cor-axial-age-t-iG} &
\includegraphics[width=0.15\linewidth]{cor-axial-age-t-iW} &
\includegraphics[width=0.15\linewidth]{cor-axial-cdr-t-iG} &
\includegraphics[width=0.15\linewidth]{cor-axial-cdr-t-iW} &
\includegraphics[width=0.15\linewidth]{cor-axial-mmse-t-iG} &
\includegraphics[width=0.15\linewidth]{cor-axial-mmse-t-iW} \\ 
%
        &
\includegraphics[width=0.15\linewidth]{cor-coronal-age-t-iG} &
\includegraphics[width=0.15\linewidth]{cor-coronal-age-t-iW} &
\includegraphics[width=0.15\linewidth]{cor-coronal-cdr-t-iG} &
\includegraphics[width=0.15\linewidth]{cor-coronal-cdr-t-iW} &
\includegraphics[width=0.15\linewidth]{cor-coronal-mmse-t-iG} &
\includegraphics[width=0.15\linewidth]{cor-coronal-mmse-t-iW} \\ 
%
        &
\includegraphics[width=0.15\linewidth]{cor-sagital-age-t-iG} &
\includegraphics[width=0.15\linewidth]{cor-sagital-age-t-iW} &
\includegraphics[width=0.15\linewidth]{cor-sagital-cdr-t-iG} &
\includegraphics[width=0.15\linewidth]{cor-sagital-cdr-t-iW} &
\includegraphics[width=0.15\linewidth]{cor-sagital-mmse-t-iG} &
\includegraphics[width=0.15\linewidth]{cor-sagital-mmse-t-iW} \\ \hline \hline
%%
\parbox[t]{4mm}{\multirow{3}{*}{\rotatebox[origin=c]{90}{Mass Imbalance}}}&
\includegraphics[width=0.15\linewidth]{cor-axial-age-t-mG} &
\includegraphics[width=0.15\linewidth]{cor-axial-age-t-mW} &
\includegraphics[width=0.15\linewidth]{cor-axial-cdr-t-mG} &
\includegraphics[width=0.15\linewidth]{cor-axial-cdr-t-mW} &
\includegraphics[width=0.15\linewidth]{cor-axial-mmse-t-mG} &
\includegraphics[width=0.15\linewidth]{cor-axial-mmse-t-mW} \\ 
%
        &
\includegraphics[width=0.15\linewidth]{cor-coronal-age-t-mG} &
\includegraphics[width=0.15\linewidth]{cor-coronal-age-t-mW} &
\includegraphics[width=0.15\linewidth]{cor-coronal-cdr-t-mG} &
\includegraphics[width=0.15\linewidth]{cor-coronal-cdr-t-mW} &
\includegraphics[width=0.15\linewidth]{cor-coronal-mmse-t-mG} &
\includegraphics[width=0.15\linewidth]{cor-coronal-mmse-t-mW} \\ 
%
        &
\includegraphics[width=0.15\linewidth]{cor-sagital-age-t-mG} &
\includegraphics[width=0.15\linewidth]{cor-sagital-age-t-mW} &
\includegraphics[width=0.15\linewidth]{cor-sagital-cdr-t-mG} &
\includegraphics[width=0.15\linewidth]{cor-sagital-cdr-t-mW} &
\includegraphics[width=0.15\linewidth]{cor-sagital-mmse-t-mG} &
\includegraphics[width=0.15\linewidth]{cor-sagital-mmse-t-mW} \\ \hline \hline
%%
\parbox[t]{2mm}{\multirow{3}{*}{\rotatebox[origin=c]{90}{Transport Cost}}}&
\includegraphics[width=0.15\linewidth]{cor-axial-age-t-tG} &
\includegraphics[width=0.15\linewidth]{cor-axial-age-t-tW} &
\includegraphics[width=0.15\linewidth]{cor-axial-cdr-t-tG} &
\includegraphics[width=0.15\linewidth]{cor-axial-cdr-t-tW} &
\includegraphics[width=0.15\linewidth]{cor-axial-mmse-t-tG} &
\includegraphics[width=0.15\linewidth]{cor-axial-mmse-t-tW} \\ 
%
        &
\includegraphics[width=0.15\linewidth]{cor-coronal-age-t-tG} &
\includegraphics[width=0.15\linewidth]{cor-coronal-age-t-tW} &
\includegraphics[width=0.15\linewidth]{cor-coronal-cdr-t-tG} &
\includegraphics[width=0.15\linewidth]{cor-coronal-cdr-t-tW} &
\includegraphics[width=0.15\linewidth]{cor-coronal-mmse-t-tG} &
\includegraphics[width=0.15\linewidth]{cor-coronal-mmse-t-tW} \\ 
%
        &
\includegraphics[width=0.15\linewidth]{cor-sagital-age-t-tG} &
\includegraphics[width=0.15\linewidth]{cor-sagital-age-t-tW} &
\includegraphics[width=0.15\linewidth]{cor-sagital-cdr-t-tG} &
\includegraphics[width=0.15\linewidth]{cor-sagital-cdr-t-tW} &
\includegraphics[width=0.15\linewidth]{cor-sagital-mmse-t-tG} &
\includegraphics[width=0.15\linewidth]{cor-sagital-mmse-t-tW} \\ \hline \hline
%
& \parbox[b][4mm]{12mm}{Age (w)} 
& \parbox[b][4mm]{12mm}{Age (g)} 
& \parbox[b][4mm]{14mm}{CDR (w)} 
& \parbox[b][4mm]{14mm}{CDR (g) }
& \parbox[b][4mm]{16mm}{MMSE (w)}
& \parbox[b][4mm]{16mm}{MMSE (g)}
\end{tabular}
\end{tabular}
...
\parbox[2mm]{7mm }{\centering $R^2$ }    &
\parbox[7mm]{7mm }{\centering CVM 1se }  & 
\parbox[7mm]{7mm }{\centering $R^2$ 1se} & 
\parbox[7mm]{7mm }{\centering CVM min }  & 
\parbox[7mm]{7mm }{\centering $R^2$ min} 
        \\ \hline \hline
\scriptsize
